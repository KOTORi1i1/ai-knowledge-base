...
> 精选好用的 Claude Code 斜杠命令、MCP 服务器和 AI 效率工具。每个推荐都附带**安装教程**和**使用示例**，新手也能快速上手。

---

## 什么是 Skills？

Skills（技能）是能**增强 AI 工具能力**的扩展和插件。就像给手机装 App 一样，给 Claude Code 装上 Skills，它就能做更多事情：

- 🔌 **连接外部服务**：让 Claude 操作数据库、浏览器、文件系统
- 🧠 **扩展专业能力**：代码审查、深度研究、自动测试
- ⚡ **提升工作效率**：一键完成复杂任务
...
<a href="/skills/tools" class="category-card">
  ...
  <div class="category-count">8 个推荐</div>
</a>
...
### ⚡ Claude Code 必装 Skills

<div class="skill-cards">

<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">/review</span>
    <span class="skill-badge green">🟢 新手友好</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">/compact</span>
    <span class="skill-badge green">🟢 新手友好</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">/init</span>
    <span class="skill-badge green">🟢 新手友好</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">GitHub MCP</span>
    <span class="skill-badge yellow">🟡 需配置</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">Brave Search MCP</span>
    <span class="skill-badge yellow">🟡 需配置</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">Filesystem MCP</span>
    <span class="skill-badge green">🟢 新手友好</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">Aider</span>
    <span class="skill-badge yellow">🟡 需配置</span>
  </div>
...
<div class="skill-card">
  <div class="skill-header">
    <span class="skill-name">Ollama</span>
    <span class="skill-badge green">🟢 新手友好</span>
  </div>
...
| 标识 | 含义 | 适合人群 |
|------|------|---------|
| 🟢 新手友好 | 几乎不需要配置，开箱即用 | 所有人 |
| 🟡 需要配置 | 需要申请 API Key 或编辑配置文件 | 有一定基础 |
| 🔴 需要开发基础 | 需要了解命令行、环境变量、Git 等 | 有开发经验 |

---

## 🔄 更新机制

- **人工精选**：每个推荐都经过实际使用验证，附真实评价
- **定期更新**：每周自动检查 GitHub 上的新 Skills/MCP 项目
- **社区驱动**：发现好用的工具？欢迎通过 GitHub Issue 推荐
